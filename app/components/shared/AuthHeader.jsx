    ...
    return (
        <div className="relative">
            ...
            <div className="absolute top-0 left-0 h-full w-full flex flex-col items-center justify-center">
                <h5 className="text-[26px] lg:text-[34px] text-primaryblack">{title}</h5>
                <div className="text-[16px] lg:text-[20px] mt-[20px] lg:mt-[30px] text-primaryblack flex items-center gap-[16px]">
