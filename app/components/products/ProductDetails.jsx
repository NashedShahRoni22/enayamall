...
export default function ProductDetails({
    ...
    console.log("affiliatedUserDetails", affiliatedUserDetails);
    ...
    const shareUrl = affiliatedUserDetails?.affiliate_code ? affProductUrl : productUrl;
                ...
                <div className="mb-[20px] flex gap-[20px]">
                    {product?.variants?.map((pv) => (
                        <button
                            ...
                            className={`border cursor-pointer ${pv?.variant === defaultVarient
