        ...
        <section className='border-t border-[#D0D0D0] pt-[50px] flex flex-col gap-[30px] lg:gap-[40px] mt-[50px]'>
            ...
            <form className='flex flex-col gap-[20px] lg:gap-[40px] xl:w-1/2' onSubmit={handleSubmit}>
                ...
                <div className='flex flex-col gap-[20px]'>
                    <p className='text-primaryblack text-[18px] font-[650]'>Your rating<span className='text-button'>*</span></p>
                ...
                <div className='flex flex-col gap-[10px] md:gap-[20px]'>
                    <p className='text-primaryblack text-[18px] lg:text-[20px] font-[650]'>Your title<span className='text-button'>*</span></p>
                ...
                <div className='flex flex-col gap-[10px]'>
                    <p className='text-primaryblack text-[18px] lg:text-[20px] font-[650]'>Upload images (optional)</p>
                    ...
                    >
                        <p className='text-ash text-[14px]'>Drag & drop or <span className='text-primaryblack underline'>click to upload</span></p>
                        <input
                            type='file'
                            multiple
                            accept='image/*'
                        ...
                        <div className='flex flex-wrap gap-4 mt-2'>
                            {images.map((img, idx) => (
                                <div key={idx} className='relative w-[80px] h-[80px] rounded overflow-hidden border border-creamline'>
                                    ...
                                    >
                                        <IoClose className='text-primaryblack text-[16px]' />
                                    </button>
                                </div>
                            ))}
                        </div>
